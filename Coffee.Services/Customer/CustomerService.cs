...
namespace Coffee.Services {
    public class CustomerService : ICustomerService {
        ...
        public CustomerService(CoffeeDbContext dbContext) {
            _db = dbContext;
        }
        ...
        public List<Coffee.Data.Customer> GetAllCustomers() {
        ...
        public ServiceResponse<Coffee.Data.Customer> CreateCustomer(Coffee.Data.Customer customer) {
            try {
                _db.Customers.Add(customer);
                _db.SaveChanges();
                return new ServiceResponse<Data.Customer> {
                    IsSuccess = true,
